      ...
      <div className="container flex items-center justify-between h-16 px-4">
        <div className="flex items-center gap-2 lg:gap-4">
          <div className="flex items-center gap-2">
            <img src="/lovable-uploads/6519ddda-0a49-4c0f-ab38-906e77b51f20.png" alt="Trader Logo" className="h-8 w-8" />
            <h1 className="text-lg font-semibold tracking-tight lg:text-xl">Trader</h1>
          </div>
